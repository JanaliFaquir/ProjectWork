...
namespace Test_Framework
{
    ...
    public class tstColour
    {
        ...
        [TestMethod]
        public void SomeColourNameMinLessOne()
        {
            //create an instance of the class we want to create
            clsColour AColour = new clsColour();
            //string variable to store any error message
        ...
        [TestMethod]
        public void SomeColourNameMinBoundary()
        {
            //create an instance of the class we want to create
            clsColour AColour = new clsColour();
            //string variable to store any error message
        ...
        [TestMethod]
        public void SomeColourNameMinPlusOne()
        {
            //create an instance of the class we want to create
            clsColour AColour = new clsColour();
            //string variable to store any error message
        ...
        [TestMethod]
        public void SomeColourNameMaxLessOne()
        {
            //create an instance of the class we want to create
            clsColour AColour = new clsColour();
            //string variable to store any error message
        ...
        [TestMethod]
        public void SomeColourNameMaxBoundary()
        {
            //create an instance of the class we want to create
            clsColour AColour = new clsColour();
            //string variable to store any error message
        ...
        [TestMethod]
        public void SomeColourNameMaxPlusOne()
        {
            //create an instance of the class we want to create
            clsColour AColour = new clsColour();
            //string variable to store any error message
        ...
        [TestMethod]
        public void SomeColourNameExtremeMax()
        {
            //create an instance of the class we want to create
            clsColour AColour = new clsColour();
            //string variable to store any error message
